			  ...
			  <div class="modal-dialog create-master-pop">
				...
				<div id="successdata_div"style="display:none;"class="alert alert-success fadein">
					...
					<div style="display:none"class="stepcontent" id="step_3">
						...
						Enter the TransactionHash and Index below for your collateral
						(
						{{$m->minbal}}{{$m->coinname}}
						)
						transaction
						...
						Format must be: transactionhash transactionindex
						</br> </label>
						<label class="c-field__label wallet-id" for="input6">
						c7a71a90cbdd7441e07eeb693efa44ecc01a1a488ccf02828827123de5fde8ef 0
						</br> </label>
