		...
		<!-- ngIf: ctrl.expired().length -->
			...
			<div id="myModal" class="modal fade" role="dialog">
			  <div class="modal-dialog create-master-pop">
				...
				<div class="prgrs"style="margin:0px;" style="display:none;">
						<div id="prgrsbar"class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="0"aria-valuemin="0" aria-valuemax="100" style="width:0%;">
											<span class="prcnt">0%</span>
						</div>
				</div>		
					...
					<div id="step_1"class="stepcontent">
						...
						<ul class="coin-detail showmecoin{{$m->id}} allcoinav"style="display:none;">
							...
							<li><i class="fa fa-hand-o-right" aria-hidden="true"></i>1 SATC will be deducted from your account balance daily for the platform hosting fee.</li>
					...
					<div style="display:none"class="stepcontent" id="step_3">
						...
						<label class="c-field__label wallet-id" for="input6">Open Notepad and paste your TXID & Output for the final step<br>After sending the payment, Enter the transaction hash below.</label>
					...
					<div style="display:none"class="stepcontent" id="step_4">
							<div class="transaction-content-detail">
									<h6>Creating your SatoshiSolutions Platform...</h6>
